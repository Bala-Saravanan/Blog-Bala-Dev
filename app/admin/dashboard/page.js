      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-8 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex flex-wrap items-center gap-3 self-start sm:self-auto">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 bg-red-50 hover:bg-red-100 dark:bg-red-950/40 dark:hover:bg-red-900/60 text-red-600 dark:text-red-400 font-semibold px-4 py-2.5 rounded-xl border border-red-200 dark:border-red-900/50 transition-all cursor-pointer text-sm shadow-xs"
          >
            <FiLogOut size={16} />
            Logout
          </button>
